	...
	vc_map( array(
		...
		"params" => array(
			...
			array(
				...
				"class" => "",
				"admin_label" => false,
				"heading" => __( "Sub Heading", "my-text-domain" ),
				"param_name" => "subheading",
				"value" => "Now you can easily track your consignment"
			),
		)
	));
}
